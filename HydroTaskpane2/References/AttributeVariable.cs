...
namespace HydroTaskpane2.References
{
    public class AttributeVariable
    {
        public static Dictionary<int, List<string>> controlAttributePairs = new Dictionary<int, List<string>>
        {
            ...
            {(int)AttributeClass_e.unit, new List<string>{ SldWorksConstants.sldworks_attr_units } },
            { (int)AttributeClass_e.measurements, new List<string>{ SldWorksConstants.sldworks_attr_dimension1, SldWorksConstants.sldworks_attr_dimension2, SldWorksConstants.sldworks_attr_dimension3 } },
            {(int)AttributeClass_e.measurements_inch, new List<string>{ SldWorksConstants.sldworks_attr_dimension1_inch, SldWorksConstants.sldworks_attr_dimension2_inch, SldWorksConstants.sldworks_attr_dimension3_inch } },
            {(int)AttributeClass_e.weight_kg, new List<string>{ SldWorksConstants.sldworks_attr_weight } },
            {(int)AttributeClass_e.weight_lbs, new List<string>{ SldWorksConstants.sldworks_attr_weight_lbs } },
            {(int)AttributeClass_e.weldassembly, new List<string>{ SldWorksConstants.sldworks_attr_weldment } },
            {(int)AttributeClass_e.components, new List<string>{ SldWorksConstants.sldworks_attr_components } },
